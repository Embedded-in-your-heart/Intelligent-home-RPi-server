...
def test_shipped_catalog_loads() -> None:
    ...
    # IMU vibration DSP characteristics
    assert "1A22000C-8E22-4541-9D4C-21EDAE82ED19" in uuids
    assert "1A22000D-8E22-4541-9D4C-21EDAE82ED19" in uuids
    assert "1A22000E-8E22-4541-9D4C-21EDAE82ED19" in uuids
